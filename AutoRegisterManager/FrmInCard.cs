...
{
    public partial class FrmInCard : Form
    {
        DC_D3 dd = new DC_D3();
        ...
        private void FrmInCard_Load(object sender, EventArgs e)
        {
        ...
        private void FrmInCard_FormClosing(object sender, FormClosingEventArgs e)
        {
